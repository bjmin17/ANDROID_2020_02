...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // 메뉴를 Activity에 부착할 때, 제일먼저 수정할 코드
        return true;
    }

    // NonNull은 이 값은 절대 Null값이 될 수 없다.
    @Override
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {

        /*
        option 메뉴 중에 터치된 메뉴의 id값을 추출하기
         */
        ...
        if(m_id == R.id.m_login) {
            ...
            // 현재 열려있는 액티비티는 .this(현재 열려있는 페이지)가 있고, 뒤에 열릴 액티비티는 .class
            Intent loginIntent = new Intent(MainActivity.this, LoginActivity.class);

            startActivity(loginIntent);

            // if문 사용하면 마지막에 return true로 완료됐다고 알려주면 좋음
            return true;
    ...
    /*
        ...
        3. onCreate() method에서
         contextMenu를 적용할 view에 registerForContext() 설정하면 된다.
     */
    @Override
