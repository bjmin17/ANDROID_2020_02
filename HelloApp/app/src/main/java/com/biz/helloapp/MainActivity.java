...
//        setContentView(R.layout.activity_main);
        ...
        // layout xml에서 선언한 객체 컴포넌트를 사용할테니 객체로 만들어달라
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Toast 버튼을 클릭하면 Toast를 띄워서 반갑습니다 문자열을 보여준다.
                // 빌드 패턴, 메서드 체인 패턴
                // Toast.LENGTH_SHORT는 보여주는 시간을 얼마로 할 것인지
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // 우리가 만든 activity 중에 화면에 보이는 activity가 intent
