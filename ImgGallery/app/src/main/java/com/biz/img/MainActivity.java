    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent를 열어 준다.
                 */
//                // 새로운 창을 열어서 값을 입력받고, 입력받은 값을 다시 되돌려 받기 위한 코드
//                Intent intent = new Intent(MainActivity.this,InputActivity.class);
//                // startActivity(intent);
//                // requestCode : 열리는 Activity와 열린 Activity가 서로 데이터를 교환할 때 사용할 ID값
//
//                startActivityForResult(intent, RequestCode.REQUEST_INPUT_CODE);
                ...
                // 이미지를 저장하는 공간
                // 내장메모리, 외장 SD 카드가 있는데 모두 나에게 접근 할 수 있게 해달라
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == RequestCode.REQUEST_IMAGE_CODE){
            ...
            if(resultCode == RequestCode.RESULT_T_OK) {
